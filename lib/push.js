...
fns.sendPush = (receiver, text) => {
    ...
    if (platform.toLowerCase() === 'android') {
        ...
        message.addData('message', text.text || text);
        ...
        console.log('DEBUG:', 'sending push android', message, registrationIds);
        ...
        console.log('DEBUG:', 'sending push apple', note, apnDevice);
